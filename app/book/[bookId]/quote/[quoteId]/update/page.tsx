...
import QuoteUpdateClient from "./QuoteUpdateClient"
...
export default async function QuoteUpdatePage({
  params,
}: {
  ...
  return (
    <QuoteUpdateClient bookId={bookId} quoteId={quoteId} initialData={initialData.quoteDetail} bookDetail={initialData.bookDetail} />
  )
}
